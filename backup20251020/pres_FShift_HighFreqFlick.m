function [timing,key,resp] = pres_FShift_HighFreqFlick(p, ps, key, RDK, conmat, blocknum, flag_training)
...
for i_tr = 1:numel(trialindex)
    ...
    [colmat,dotmat,dotsize,rdkidx,frames] = RDK_init_FShift_HighFreqFlick(RDKin.scr,RDKin.Propixx,RDKin.RDK,RDKin.trial,RDKin.crs);
